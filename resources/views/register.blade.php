    ...
    <div class="wrapper">
        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    <dl>
                        <s class="phone"></s><input id="userMobile" maxlength="11" type="number" placeholder="请输入您的手机号码" name="admin_tel" />
                        <span class="clear">x</span>
                    </dl>
                    <dl>
                        <s class="password"></s>
                        <input class="pwd" maxlength="11" type="text" placeholder="6-16位数字、字母组成" name="admin_pwd" />
                        <input class="pwd" maxlength="11" type="password" placeholder="6-16位数字、字母组成" name="admin_pwd" style="display: none" />
                    ...
                    <dl>
                        <s class="password"></s>
                        <input  maxlength="11" class="clod" type="text" placeholder="请输入验证码" value="" />
                ...
                <li><a id="btnNext" href="javascript:;" class="orangeBtn loginBtn">下一步</a>
                </li>
            </ul>
        </div>
...
<script>
    $(function(){
        ...
        //点击注册
        $('#btnNext').click(function(){
            var admin_tel=$("#userMobile").val();
                    {{--console.log(admin_tel);--}}
            var admin_pwd=$(".pwd").val();
            var new_pwd=$('.conpwd').val();
            var code=$('.clod').val();
            {{--console.log(_token);--}}
        ...
        $('#code').click(function () {
            ...
            $.post(
                "codedo",
                {_token:_token,admin_tel: admin_tel},
                function (res) {
                    console.log(res);
                }
            )
